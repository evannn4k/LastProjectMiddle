    ...
    <div class="flex-1">
        <section class="bg-white dark:bg-gray-900">
            <div class="mx-auto max-w-2xl py-4 px-4 md:py-12 md:px-0">
                <div class="w-full bg-neutral-primary-soft shadow-xs rounded-2xl border border-default">
                        ...
                        <div class="flex flex-col gap-5">
                            ...
                            <div class="">
                                <div class="flex items-center justify-between gap-4 py-3">
                                    ...
                                    <div class="text-base font-medium text-gray-900 dark:text-white">{{ $order->id_bill }}
                                    </div>
                                </div>
                                <div class="flex items-center justify-between gap-4 py-3">
                                    <div class="text-base font-normal text-gray-500 dark:text-gray-400">ID Akun Game</div>
                                    <div class="text-base font-medium text-gray-900 dark:text-white">
                                        {{ $order->id_account }}</div>
                                </div>
                                <div class="flex items-center justify-between gap-4 py-3">
                                ...
                                <div class="bg-gray-50 md:mx-4 mx-2 mt-6 mb-4 rounded-lg px-4 py-2">
                                    <div class="flex items-center justify-between gap-4 py-3">
                                        <div class="text-base font-normal text-gray-500 dark:text-gray-400">Harga Produk
                                        </div>
